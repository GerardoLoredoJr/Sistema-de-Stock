...
void limpiar(){
    ...
    campor_tipo_factura.setText("");
    campo_factura.setText("");
    campo_sucursa.setText("");
    campo_monto.setText("");
    ...
    private void initComponents() {
        ...
        botonguardar.setFont(new java.awt.Font("Calibri", 0, 11)); // NOI18N
        ...
        botonsalir.setFont(new java.awt.Font("Calibri", 0, 11)); // NOI18N
        ...
        jPanel1.add(botonsalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, 90, -1));

        botonmodificar.setFont(new java.awt.Font("Calibri", 0, 11)); // NOI18N
        ...
        botonagregar.setFont(new java.awt.Font("Calibri", 0, 11)); // NOI18N
        ...
        campo_fecha.setMinSelectableDate(new java.util.Date(-62135755099000L));
        getContentPane().add(campo_fecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 80, 220, -1));
    ...
    private void botonguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonguardarActionPerformed
        ...
        if(control.equals("0")){
            try {
                ...
                ps.setString(1, format.format(dete));
                ...
                inhabilitar();
                limpiar();
                TablaDeFacturasCompras.cargar_tabla();
            } catch (SQLException ex) {
                Logger.getLogger(Factura_Compras.class.getName()).log(Level.SEVERE, null, ex);
            }
        }else{
    ...
    public static com.toedter.calendar.JDateChooser campo_fecha;
    ...
    public static javax.swing.JComboBox<String> combo_estado;
    public static javax.swing.JComboBox<String> combo_proveedor;
