...
public class Registro extends javax.swing.JInternalFrame {
    ...
    void inhabilitar() {
        ...
        CampoPalabraClave.setEnabled(false);
    ...
    private void initComponents() {
        ...
        CampoPalabraClave = new javax.swing.JPasswordField();
        jLabel10 = new javax.swing.JLabel();

        setTitle("Registrarse");
        setMaximumSize(new java.awt.Dimension(519, 345));
        setMinimumSize(new java.awt.Dimension(519, 345));
        setPreferredSize(new java.awt.Dimension(519, 345));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 150, 290));
        ...
        getContentPane().add(nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(238, 49, 258, -1));

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Apellido:");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 80, -1, -1));
        getContentPane().add(apellido, new org.netbeans.lib.awtextra.AbsoluteConstraints(238, 80, 258, -1));

        jLabel5.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Usuario:");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 110, -1, -1));
        getContentPane().add(usuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(238, 111, 258, -1));
        ...
        getContentPane().add(contraseña1, new org.netbeans.lib.awtextra.AbsoluteConstraints(238, 142, 258, -1));
        ...
        getContentPane().add(contraseña2, new org.netbeans.lib.awtextra.AbsoluteConstraints(238, 176, 258, -1));
        ...
        getContentPane().add(Permisos, new org.netbeans.lib.awtextra.AbsoluteConstraints(238, 207, 258, -1));

        jLabel11.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("<html>Palabra Clave:</html>");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 240, 60, -1));
        getContentPane().add(CampoPalabraClave, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 240, 258, 20));

        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/fondo.jpg"))); // NOI18N
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 0, 360, 290));
    ...
    private void RegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegistrarActionPerformed
        ...
        try {
            if (con1.equals(con2)) {
                ps = con.prepareStatement("INSERT INTO usuarios(nombre, apellido, usuario, contraseña, contraseña2, permisos_id_permiso, palabraclave) VALUES(?,?,?,?,?,?,?)");
                ...
                ps.setInt(6, Permisos.getSelectedIndex());
                ps.setString(7, String.valueOf(CampoPalabraClave.getPassword()));
    ...
    public void habilitarFrm() {
        ...
        CampoPalabraClave.setEnabled(true);
        this.nombre.requestFocus();
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JPasswordField CampoPalabraClave;
