...
void limpiar(){
    ...
    private void initComponents() {
        ...
        nuevocliente.setFont(new java.awt.Font("Calibri", 0, 11)); // NOI18N
        nuevocliente.setText("Nuevo Cliente");
        nuevocliente.setToolTipText("Al precionar Nuevo Cliente... Podra registrar un Cliente nuevo");
        ...
        Guardar.setToolTipText("<html>Al precionar Guardar... Guarda un nuevo cliente o Modifica un cliente Dependiendo el boton ejecutado anteriormente</html>");
        ...
        modificar.setToolTipText("Al precionar Modificar, usted podra seleccionar un cliente de la tabla para poder modificarlo, luego que lo modifica precione Guardar");
        ...
        eliminar.setFont(new java.awt.Font("Calibri", 0, 11)); // NOI18N
    ...
    private void GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GuardarActionPerformed
        ...
        if (per == 0) {
            ...
            if(nombre.getText()==null){
                JOptionPane.showMessageDialog(null, "Debe completar como minimo el 'nombre' del cliente para Guardar uno");
            }else{
              try {
